	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for (int t = 0; t < trials; t++) {
				BasicDocument basicDoc = new BasicDocument(string);
				basicDoc.getFleschScore();
			}
			long endTime = System.nanoTime();
			long estTime = (long) ((endTime - startTime) / 1000); // Math.pow(10, 9));
			
			System.out.print(estTime + "\t");
			
			startTime = System.nanoTime();
			for (int t = 0; t < trials; t++) {
				EfficientDocument effDoc = new EfficientDocument(string);
				effDoc.getFleschScore();
			}
			endTime = System.nanoTime();
			estTime = (long) ((endTime - startTime) / 1000); // Math.pow(10, 9));
